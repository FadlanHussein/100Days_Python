...
# Daftar karakter ASCII dari gelap ke terang (atau sebaliknya)
ASCII_CHARS = "@%#*+=-:. "

def load_image(image_path, new_width=100):
    # Buka gambar
    img = Image.open(image_path)
    # Hitung aspect ratio (font terminal ~0.55 tinggi per lebar)
...
def map_pixels_to_ascii(img):
    ...
    # Skalakan nilai pixel (0-255) ke indeks karakter ASCII
...
def generate_ascii_art(image_path, new_width=100):
    ...
    # Format baris demi baris berdasarkan lebar gambar
...
def main():
    ...
    if not image_path:
        ...
        # Coba cari di dalam folder images/
